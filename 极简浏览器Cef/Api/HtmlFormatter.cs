...
namespace 极简浏览器
{
    ...
    public class SafeHtmlParser
    {
        ...
        private string a(char A_0)
        {
            ...
            int num2 = this.fd.IndexOf('<', this.fg, num1 - this.fg);
            if (num2 != -1)
            {
                num1 = num2;
            }
        ...
        private string a(out string arg)
        {
            int num1 = this.fg;
            arg = this.d();
            string text1 = this.b();
        ...
        private static string a(string arg)
        {
            ...
            if (((obj1 = arg.ToLower()) != null) && ((obj1 = r[obj1]) != null))
            {
                switch ((int)obj1)
                {
            ...
            try
            {
                char ch1 = (char)((ushort)short.Parse(arg.Substring(2, arg.Length - 3)));
                text1 = ch1.ToString();
            }
            catch
            {
        ...
        private string a(params char[] args)
        {
            if (this.fg >= this.ff)
            {
                return "";
            }
            int num1 = this.fd.IndexOfAny(args, this.fg);
            if (num1 == -1)
            {
                return this.e();
            }
        ...
        private void a(XmlElement arg)
        {
            ...
            if (text1 != null)
            {
                ...
                arg.AppendChild(this.fc.CreateProcessingInstruction(text1, this.a('>')));
            }
            else
            {
                arg.AppendChild(this.fc.CreateTextNode("<?"));
            }
        }
        private void a(XmlElement arg0, string arg1, string arg2)
        {
            arg1 = arg1.ToLower();
            if (arg1.IndexOf(':') == -1)
            ...
            {
                chArray1 = new char[1] { ':' };
                string[] textArray1 = arg1.Split(chArray1, 2);
                string text1 = textArray1[0];
                string text2 = textArray1[1];
                if (string.IsNullOrEmpty(text1))
                    arg0.SetAttribute(text2, arg2);
                else if (string.IsNullOrEmpty(text2))
                    arg0.SetAttribute(text1, arg2);
                else
                    arg0.SetAttribute(text2, arg2);
            }
        }
        ...
        private string b(char ch)
        {
            ...
            int num1 = this.fd.IndexOf(ch, this.fg);
            if (num1 == -1)
            {
                return this.f();
            }
        ...
        private static string b(string arg)
        {
            ...
            {
                int num4 = arg.IndexOfAny(fh, num3 + 1);
                if (num4 == -1)
                {
                    break;
                }
                if (arg[num4] == '&')
                {
                    builder1.Append(arg, num2, (int)(num4 - num2));
                    num3 = num4;
                    continue;
                }
                if (num2 != num3)
                {
                    builder1.Append(arg, num2, (int)(num3 - num2));
                }
                builder1.Append(SafeHtmlParser.a(arg.Substring(num3, (num4 + 1) - num3)));
                num2 = num4 + 1;
                if (num2 >= num1)
                {
                    break;
            ...
            if (num2 < num1)
            {
                builder1.Append(arg, num2, (int)(num1 - num2));
            }
            return builder1.ToString();
        }
        ...
        private int ff;
        private int fg;
        private static char[] fh = new char[2] { '&', ';' };
        private static char[] chArray1 = new char[2] { '&', ';' };
    }
}